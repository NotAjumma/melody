...
<div style="min-height:100vh;">
    ...
    <div class="header-payment">
      ...
      <div class="first-time-plan">
        <div class="top-inside-header">
          <div class="first-top">
            ...
            <div class="right-top-details">
              <div class="free-text">3 months</div>
            </div>
          </div>
          <div class="sec-top">
            <div>
            ...
            <div class="right-top-details">
              <div class="small-text">For RM47.70</div>
            </div>
          </div>
        </div>
        <div class="bottom-inside-header">
          ...
          $duration = 3; // Replace with the actual duration in months
  ...
  <div class="" style="width:30%; margin: 0 auto;">
    <?php  if (!empty($cards)){ ?>
      ...
      <input type="hidden" name="total_amount" value="47.70" />
      <input type="hidden" name="total_duration" value="3" />
