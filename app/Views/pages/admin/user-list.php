...
<div>
        ...
        <tbody>
          ...
          <tr class="table-row-data karla-regular-small-text">
            ...
            <td class="table-data">
              ...
              <a onclick="return confirmDelete('<?php echo $user['username']; ?>')" href="<?php echo ('delete/'.$user['username']);?>" class="btn btn-danger btn-sm">Delete</a>
            </td>
          </tr>
          <?php endforeach; ?>
          <?php endif; ?>
  ...
  return confirm("Are you sure you want to delete this user, Username:  "+ username +" ?");
}
  </script>
