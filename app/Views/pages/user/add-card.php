<div class="info-top-layer">
    <div class="list-card">
      <div class="karla-medium-text">Credit or debit card</div>
      <div class="cards">
        <!-- Visa Card -->
        <div class="card-container">
          <img src="<?= base_url('assets/card/visa.png') ?>" />
        </div>
        <!-- Master Card -->
        <div class="card-container">
          <img src="<?= base_url('assets/card/mastercard.png') ?>" />
        </div>
        ...
        <!-- UnionPay -->
        <div class="card-container">
          <img src="<?= base_url('assets/card/union.png') ?>" />
        </div>
      </div>
    </div>
    <div class="top-payment-details">
      <div class="karla-medium-text">Payment details</div>
      <div class="tooltip">
        <i class="fa-solid fa-lock fa-lg"></i>
        <span class="tooltiptext">Transactions are encrypted and secure.</span>
      </div>
    </div>
  </div>
