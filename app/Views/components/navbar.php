    ...
    <div class="right-nav">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link dropdown-toggle" href="#">Premium <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item ">
          <a class="nav-link dropdown-toggle" href="#">Support</a>
        </li>
        <div class="nav-item ">
...
<div class="sidebar" >
  ...
  <div class="sidebar-buttons">
    ...
    <div class="sidebar-button" onclick="sidebarButton('<?php base_url()?>','verify-membership')">
      <div><i class="fa-solid fa-money-check" style="color: #ffffff;"></i></i></div>
      <div class="sidebar-button-name">
        Membership Payment
      </div>
    ...
    <div class="sidebar-button" onclick="sidebarButton('<?php base_url()?>','edit-profile')">
      <div><i class="fa-solid fa-user-pen" style="color: #ffffff;"></i></i></div>
      <div class="sidebar-button-name">
        Edit Profile
      </div>
    </div>
